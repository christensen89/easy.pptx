<?php
  ...
  $sql="select p.id, p.navn, f.fagkode, pe.ar, pe.termin from powerpoint as p join fag as f on f.id=p.fag_id join periode as pe on pe.id=f.periode_id order by f.fagkode;";
